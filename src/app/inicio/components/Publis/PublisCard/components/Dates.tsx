...
export default function Dates({ id, fechaInicio, fechaFin }: any) {
            ...
            <Popover>
                ...
                <PopoverContent>
                    <Calendar
                        mode="single"
                        // selected={date}
                        onSelect={(e) => { updateInitialTime(e, id); if (e) { setStartDate(id, e) } }}
            ...
            <Popover>
                ...
                <PopoverContent>
                    <Calendar
                        mode="single"
                        // selected={date}
                        onSelect={(e) => { updateEndTime(e, id); if (e) { setEndDate(id, e) } }}
                        className="rounded-md flex justify-center border"
                    />
                </PopoverContent>
            </Popover>
