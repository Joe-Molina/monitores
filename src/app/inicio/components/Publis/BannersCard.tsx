...
export const BannersCard = ({ publi, user }: any) => {
    const {deletePost, setPosition, setEndDate, setStartDate} = usePostsContext()
    ...
    return (
        <div className='shadow-lg flex flex-col justify-between  cover rounded-sm overflow-hidden w-[500px]  bg-neutral-900  border border-neutral-600'>
            <div className='p-1 '>
