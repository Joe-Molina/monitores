...
export default function Nav() {
  return (
    <aside className="sm:flex [grid-area:aside] lg:flex-col flex overflow-y-auto bg-neutral-950 text-white items-center border-r border-neutral-700  sticky lg:relative z-40  top-0" >
